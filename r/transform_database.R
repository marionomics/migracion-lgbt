...
global <- c("Nacional", "Nueva", "Usada",
            ...
            "Econ<U+00F3>mica - Social", "Media - Residencial",
            "ZM Valle México", "ZM Guadalajara",
            "ZM Monterrey", "ZM PueblaTlax", "ZM Toluca",
            "ZM Tijuana", "ZM Le<U+00F3>n", "ZM Quer<U+00E9>taro")

states
shf2 <- shf %>%
    filter(Trimestre == 1) %>%
    filter(Year %in% 2017:2022)%>% # Año
